...
import { ChevronLeft, Plus, Play, Pause, Square, Settings, User, Calendar, Clock, Activity, AlertCircle, CheckCircle, ArrowLeft } from 'lucide-react';

const UnifiedResearchApp = () => {
  ...
  const requiredFields = [
    { key: 'participantId', label: 'Animal ID', value: selectedAnimal?.name || '' },
    { key: 'trialType', label: 'Trial Type', value: selectedTrial?.name || '' },
                ...
                <div className="space-y-4 mb-6">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="text-sm text-gray-600 space-y-1">
                      <p><span className="font-medium">Animal:</span> {selectedAnimal?.name}</p>
                      <p><span className="font-medium">Trial Type:</span> {selectedTrial?.name}</p>
                      <p><span className="font-medium">Expected Duration:</span> {selectedTrial?.duration}</p>
...
export default UnifiedResearchApp;
